            ...
            <Grid container direction="column" alignItems="center" spacing={2}>
              <Grid item>
                <Avatar
                  ...
                  src={userDetails && `${baseUrl}${userDetails.image}`}
                  style={{
                    width: "10rem",
                    height: "10rem",
                    marginBottom: "2rem"
              ...
              <Grid item>
                <Typography
                  variant="subtitle1"
                  style={{ color: "#757575", marginBottom: "2rem" }}
                >
              ...
              {userDetails?.is_submit ? null : (
                <Grid item>
                  <Link to="/teacher/register" style={{ color: "blue" }}>
                    If you want to become a teacher here?
                  </Link>
                </Grid>
              )}
              {userDetails?.is_pending ? (
                <Grid item>
                  <span>Application is on </span>&nbsp;
                  <Label
                    color={userDetails?.is_pending ? "warning" : "success"}
                  >
