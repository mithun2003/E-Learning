...
const Courses = () => {
  ...
  return (
    // <Box sx={{ width: "100vw", backgroundColor: "white", height: "100vh" }}>
    //   <Typography
    //     sx={{
    //       color: "#1D5564",
    //       fontStyle: "normal",
    ...
    //     <Box sx={{ width: "100vw", height: "100%", backgroundColor: "white"}} mb={5}>
    //       <Box sx={{ display: "flex", justifyContent: "space-between", px: 8,marginLeft:"2rem" }}>
    //         <Box sx={{ width: 652 }}>
    //           <Typography
    //             variant="h2"
    //             sx={{  color: "#1D5564", lineHeight: "3",fontWeight:"300",minWidth:"15rem" }}
    //           >
    //             Browse courses
    //           </Typography>
    ...
    //             {" "}
    //             <Typography
    //               sx={{ fontSize: "base", fontWeight: "medium", color: "white" }}
    //             >
    //               See More
    //             </Typography>
    //           </Button>
    ...
    // <Grid container spacing={2} sx={{marginLeft:"4.5rem"}} my={2}>
    //       {cardData.map((card, index) => (
    //         <Grid item xs={12} sm={6} md={4} key={index}>
    //           <Card sx={{ width: "70%", height: "100%",borderRadius:0,marginRight:"1rem" }}>
    //             <CardMedia
    //               component="img"
    ...
    //             />
    //             <CardContent>
    //               <div className="flex flex-col space-y-5 items-start justify-start pb-10">
    //                 <div className="inline-flex items-start justify-start pr-6">
    //                   <Typography variant="h5" component="div">
    //                     {card.title}
    //                   </Typography>
    //                 </div>
    //                 <div className="inline-flex items-end justify-center w-full h-1/2 pr-1 pt-1">
    ...
    //               </div>
    //             </CardContent>
    //             <Box sx={{ p: "10px", textAlign: "right" }}>
    //                 <Button sx={{color:"#1D5564"}} startIcon={<FavoriteBorderIcon />} size="medium"></Button>
    //               </Box>
    //           </Card>
    //         </Grid>
    //       ))}
    ...
    //       margin: "20 0 0 4",
    //     }}>
    //     Web Development from Beginning
    //     <br />
    //     to Pro
    //   </p>
    //   <div
    ...
    //       fill="none"
    //       xmlns="http://www.w3.org/2000/svg">
    //       <path d="M0 0.939941H255.5" stroke="#BEBEBE" />
    //     </svg>
    //   </div>
    //   <div
    //     style={{
