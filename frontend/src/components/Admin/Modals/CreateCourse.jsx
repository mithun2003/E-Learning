    ...
    <>
        <Dialog open={onOpen} onClose={handleCloseModal}>
          ...
          <DialogContent>
            ...
            {formErrors.teacher? <p style={{ color: "red", marginBottom: "8px",marginTop:'-5px' }}>
                This field is require
              </p>:""}
            {/* <FormControl fullWidth sx={{marginBottom:1}} error={formErrors.cat?true:false}>
              <label
              ...
              {formErrors.cat && <FormHelperText>Please choice categories</FormHelperText>}
            </FormControl> */}
