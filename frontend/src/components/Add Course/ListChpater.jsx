...
<Grid container spacing={2} sx={{marginLeft:"4.5rem",marginBottom:3}} my={3}>
      ...
      >
        ...
        >
          ...
          <Button variant='contained' color='error' onClick={()=>handleDelete(card.id)} sx={{left:'11vh',top:'1vh'}}>Delete</Button>
